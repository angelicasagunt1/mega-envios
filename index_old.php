...
<iframe align="center" width="100%" height="800px" src="<?='templates/transferencias.php';?>" 
  frameborder="no" scrolling="no" name="myIframe" id="myIframe"> </iframe>



  <div><?php include 'templates/banesco.php'?></div>
    <div><?php include 'templates/mercantil.php'?></div>
